 ...
 * в пользу более новых и сократили бы латентность. Это не успел сделать, да и не факт что это можно нормально
 * сделать без определенной обратной связи от проксируемого сервиса и накопления статистики.
 *
